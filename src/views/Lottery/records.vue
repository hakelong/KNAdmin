  ...
  <div class="menu">
    ...
    <div class="portlet">
      ...
      <div class="portlet-title">
        <div class="caption">
          <Icon type="ios-gear-outline"></Icon>  抽奖记录
        </div>
        <div align='right'>
      ...
      <div class="portlet-body">
        <div class='search-bar'>
          <span>抽奖产品名称：</span><Input v-model='table.prizeName' style="width:120px;"></Input>
          <span>用户昵称：</span><Input v-model='table.nickName' style="width:120px;"></Input>
          <Button  @click='getData'>搜索</Button>
          <Select v-model="table.type" style="width:120px;float:right" @on-change='typeChange'>
